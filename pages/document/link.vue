    ...
    <div class="container">
      ...
      <div v-if="document.activate" class="how">
        ...
        <div class="how-desc">
          ...
          <div>
            Вход доступен только одним способом: по ссылке и паролю. При потере
            названия ссылки или пароля, восстановление доступа невозможно.
            Скопируйте данные и сохраните их в надёжном месте.
          </div>
        </div>
        <div class="how-desc">
          <div class="how-desc__icon">
          ...
          <div>
            Адресат имеет право на удаление документа, но только после его
            скачивания.
          </div>
        </div>
        <div class="how-desc">
